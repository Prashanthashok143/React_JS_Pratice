...
import { increment, decrement, GetTodo } from "./CounterPratice";
...
const Dispatch = () => {
  ...
  const error=useSelector((state)=>state.CounterSlice.error)
  const data=useSelector((state)=>state.CounterSlice.todos)
  ...
  return (
    <div>
      ...
      <Button variant="dark" onClick={() => dispatch(GetTodo(
